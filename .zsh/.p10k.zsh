# Generated by Powerlevel10k configuration wizard on 2020-11-12 at 05:45 JST.
...
# dotted, no frame, dark-ornaments, sparse, many icons, concise, instant_prompt=verbose.
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIINS_CONTENT_EXPANSION='(🌻・ワ・)'
